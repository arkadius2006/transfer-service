...
public class ClientTest {
    ...
    public void transferFifty() throws IOException {
        ...
        // check
        Assert.assertEquals("Account 1", 100.0, client.get("1").getAmount(), 1E-5);
        Assert.assertEquals("Account 1", 200.0, client.get("2").getAmount(), 1E-5);
        ...
        // check again
        Assert.assertEquals("Account 1", 50.0, client.get("1").getAmount(), 1E-5);
        Assert.assertEquals("Account 1", 250.0, client.get("2").getAmount(), 1E-5);
